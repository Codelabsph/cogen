        ...
        <Section flexRow={"center"} spacing={"md"}>
          ...
          <div className="w-1/2 xxs:w-full">
            ...
            <p className="py-12 text-xl">
              You pay the upfront cost and own the solar rooftop system, or we
              pay the upfront cost and receive monthly payments from you based
              on pay-per-use agreement.
            </p>
