...
const SectionFeatureTwo = () => {
  return (
    <>
      ...
      <section class=" w-full bg-white px-6 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pb-4 f2">
        <h1 class="z-50 relative text-3xl font-bold font-playfair  sm:text-3xl md:text-5xl lg:text-6xl  pt-20 xxs:text-5xl">How to Save
        </h1>
