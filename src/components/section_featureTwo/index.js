...
const SectionFeatureTwo = () => {
  return (
    <>
      <div className=" bg-gray-100 h-2/3 w-full  absolute"></div>
      <section className=" w-full bg-white px-6 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pb-4 f2">
        <h1 className="z-50 relative text-3xl font-bold font-playfair  sm:text-3xl md:text-5xl lg:text-6xl  pt-20 xxs:text-5xl">
          How to Save
        </h1>
        <div className="flex md:flex-row sm:flex-col xxs:flex-col lg:-mx-8 my-8  font-poppins">
          <div className="z-50   w-1/2  md:w-full xxs:w-full sm:w-full xxs:py-4 ">
            <div className="mx-8">
              <img
                className="h-screen w-full xxs:h-auto  "
