        ...
        <div className=" flex md:flex-row sm:flex-col xxs:flex-col lg:-mx-8 my-8  font-poppins xxs:text-center">
            <div className="w-1/2 lg:w-1/2 lg:px-8  md:w-full xxs:w-full sm:w-full">
                <div className="z-50 relative">
                    <img className="w-full xxs:h-auto" src="../assets/img/case-card.png" />
                </div>
            </div>
            ...
            <div className=" z-50 relative  w-1/2 lg:w-1/2 md:w-full xxs:w-full sm:w-full lg:px-8">
                ...
                <div className="flex flex-row py-4 space-x-14 xxs:flex-col xxs:space-x-0">
                    <div className="">
                        ...
                        <TextWithHeading title="Grid-tied solar PV system" content="Panel Type" />

                    </div>
                    <div className="">
                        <TextWithHeading title="June 24, 2020" content="Installation Date" />
                        <TextWithHeading title="Php 2,500+" content="Average Monthly Bill" />
                ...
                <div className="flex flex-row my-4 xxs:flex-col w-full text-center  justify-between space-x-24 xxs:space-x-0">
                    <HeadingWithText title="3.51 MWh" content="Total yield" />
                    <HeadingWithText title="161.10 kWh" content="Monthly yield" />
                    <HeadingWithText title="$145.67" content="Monthly savings" />
                    <HeadingWithText title="3.52ts" content="CO2 Reduction" />
