...
const FullCard = ({ title, paragraph, icon, explore }) => {
  return (
    <section className="w-full bg-white sm:px-8 lg:px-16 xl:px-44 2xl:px-64 pb-4 f2">
    <div class="relative w-full border-gray-200 rounded-xl border-2 p-16 mx-auto shadow-lg overflow-hidden">
      ...
      <h1 className="text-4xl font-bold font-playfair mb-6 xxs:text-2xl">No property?</h1>
      <p className="text-2xl xxs:text-lg">
        You don't need to have your own solar rooftop installation to join the
        energy transition.
        <br /> Help the environment while earning money through <span><a class="text-cogengreen font-semibold" href="">our co-ownership
        program</a></span>
      </p>
      </div>
    </div>
