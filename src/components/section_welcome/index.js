    ...
    <>
      <section className="w-full bg-white px-6 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-32">
        ...
        <p className="text-xl font-poppins">
          We offer a platform that creates opportunities for energy consumers
          and other stakeholders to participate and benefit from the clean
          energy transition.
        </p>
        <div className="flex md:flex-row sm:flex-col xxs:flex-col lg:-mx-8 my-8  font-poppins">
            ...
            <div className="mt-10">
              ...
              <div className="my-14 flex">
                ...
                <div className="ml-8  font-poppins">
                  ...
                  <p className="my-2 leading-relaxed">
                    Know your customer requirements and installed system status
              ...
              <div className="flex">
                ...
                <div className="ml-8  font-poppins">
                  ...
                  <p className="my-2 leading-relaxed">
                    Own a solar system now at cheaper upfront cost through our
          ...
          <div className="w-1/2 lg:w-1/2 md:w-full xxs:w-full sm:w-full lg:px-8"></div>
        </div>
      </section>
    </>
  );
